...
import { Linl as RouteLink } from 'react-router-dom';
             ...
             sx={{ position: "static", background: "#fff" }}>
                <Toolbar>
                    ...
                    >
                      ...
                      <Tab label="Best Sellers" sx={{color: 'black'}} />
                      <Tab label="Store Basics" sx={{color: 'black'}} />
                      <Tab label="Customer Services" sx={{color: 'black'}} />
                      <Tab label="Todqay's Deals" sx={{color: 'black'}} />
                      <Tab label="New Releases" sx={{color: 'black'}} />
